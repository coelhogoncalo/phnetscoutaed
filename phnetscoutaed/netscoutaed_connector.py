...
class NetscoutAedConnector(BaseConnector):
    ...
    def _handle_block_ip(self, param):
        ...
        # make rest call
        ret_val, response = self._make_rest_call(
            NETSCOUTAED_REST_BLOCKED_IPS, action_result, params=None, data=json_data, method='post', headers={
                'X-Arbux-APIToken': self._api_token,
                'Accept': 'application/json',
    ...
    def _handle_allow_ip(self, param):
        ...
        # make rest call
        ret_val, response = self._make_rest_call(
            '/endpoint', action_result, params=None, method='post', headers={
                'X-Arbux-APIToken': self._api_token,
                'Accept': 'application/json',
                'Content-Type': 'application/json'
            }
    ...
    def _handle_disallow_ip(self, param):
        ...
        # make rest call
        ret_val, response = self._make_rest_call(
            '/endpoint', action_result, params=None, method='delete', headers={
                'X-Arbux-APIToken': self._api_token,
                'Accept': 'application/json',
                'Content-Type': 'application/json'
            }
